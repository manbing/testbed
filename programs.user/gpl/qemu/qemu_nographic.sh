...
x86)
	sudo qemu-system-x86_64 -smp 2 -m 1024M -kernel ./x86_64-linux/kernel/bzImage -initrd ./x86_64-linux/rootfs.cpio.gz -append "root=/dev/ram rdinit=/sbin/init console=ttyS0" -nographic -net nic -net tap,ifname=tap0,script=no
;;
